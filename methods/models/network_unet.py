...
class UNetRes(nn.Module):
    def __init__(
        ...
        self.m_down1 = B.sequential(
            *[
                B.ResBlock(nc[0], nc[0], bias=bias, mode="C" + act_mode + "C")
                for _ in range(nb)
            ],
        ...
        self.m_down2 = B.sequential(
            *[
                B.ResBlock(nc[1], nc[1], bias=bias, mode="C" + act_mode + "C")
                for _ in range(nb)
            ],
        ...
        self.m_down3 = B.sequential(
            *[
                B.ResBlock(nc[2], nc[2], bias=bias, mode="C" + act_mode + "C")
                for _ in range(nb)
            ],
        ...
        self.m_body = B.sequential(
            *[
                B.ResBlock(nc[3], nc[3], bias=bias, mode="C" + act_mode + "C")
                for _ in range(nb)
            ]
        )
